...
class ContractorProfile(BaseModel):
    ...
    # Labour
    labour_rates: LabourRates = LabourRates()
    ...
    custom_prices: Dict[str, float] = {}   # e.g. {"600x1200 Recessed LED": 720.0}
...
class BuildingBlock(BaseModel):
    ...
    supply_from: str = ""
    supply_cable: str = ""
    sld_drawings: List[str] = []
    layout_drawings: List[str] = []
...
class ExtractionResult(BaseModel):
    ...
    defects: List[Any] = []   # Maintenance/COC mode
