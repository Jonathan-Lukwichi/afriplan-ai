"""
AfriPlan Electrical v1.0 - Quick Estimate (Secondary Mode)

⚠️ QUICK BALLPARK QUOTES ONLY — For accurate extraction, use Smart Upload.

Single-file workflow: Upload → Auto-Extract → Export
- No human validation (AI extracts everything automatically)
- Expected accuracy: 30-50%
- Best for: Simple residential, quick demos, rough estimates

For commercial projects requiring 75%+ accuracy, use Smart Upload instead.
"""
...
page_header(
    ...
    subtitle="Fast Ballpark Quotes"
)

# Warning Banner
st.warning(
    "⚠️ **Quick Estimate Mode** — Automated extraction without human validation. "
    "Expected accuracy: 30-50%. For accurate quotes on commercial projects, "
    "use **Smart Upload** instead.",
    icon="⚡"
)
